      ...
      >
        ...
        <div className="mb-12">
          ...
          <div className="mt-8 mb-8 flex justify-center">
            <div className="w-7 h-12 border-2 border-slate-400 dark:border-slate-600 rounded-full flex justify-center pt-2">
              <div className="w-1.5 h-2.5 bg-slate-600 dark:bg-slate-400 rounded-full animate-scroll-bounce"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          {[
            ...
            <div key={i} className="flex items-center gap-2 hover:-translate-y-1 transition-all cursor-pointer group">
              <i className={`${tech.icon} grayscale group-hover:grayscale-0 transition-filter duration-300`} style={{ fontSize: '1.25rem' }}></i>
